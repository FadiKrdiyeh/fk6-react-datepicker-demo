import { CalendarPositionsEnum, CalendarsEnum, CalendarViewsEnum, DatePicker, DateTimePicker, ThemesEnum } from "@fk6/react-datepicker";
...
export default function Examples() {
    ...
    const state = {
        hasPosition: !!position && position?.id !== CalendarPositionsEnum.Bottom,
        hasLocale: !!locale && locale?.id !== 'en',
        hasTheme: (!!theme && theme?.id !== ThemesEnum.Light),
        hasCalendar: !!calendar && calendar?.id !== CalendarsEnum.Gregorian,
        hasInitialView: !!initialView && initialView?.id !== CalendarViewsEnum.Days,
                ...
                <div className={styles.container} style={{ padding: '20px 100px' }}>
                    ...
                    >
                        <div className={styles["grid-item"]}>
                            {/* Calendar */}
                            <SelectField
                                options={generateListFromEnum(CalendarsEnum)}
                                value={calendar}
                        ...
                        <div className={styles["grid-item"]}>
                            {/* Position */}
                            <SelectField
                                options={generateListFromEnum(CalendarPositionsEnum)}
                                value={position}
                        ...
                        <div className={styles["grid-item"]}>
                            {/* Theme */}
                            <SelectField
                                options={generateListFromEnum(ThemesEnum)}
                                value={theme}
                        ...
                        <div className={styles["grid-item"]}>
                            {/* Initial View */}
                            <SelectField
                                options={generateListFromEnum(CalendarViewsEnum)}
                                value={initialView}
